...
void loop() {
    ...
    if (nfc.tagPresent()) {
        ...
        message.addTextRecord("bram.debaerdemaeker@test.com"); // Text Message you want to Record
        message.addTextRecord("password"); // Text Message you want to Record
        //message.addUriRecord("paswoord"); // Website you want to Record
